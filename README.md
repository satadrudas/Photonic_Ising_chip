...
There are 2 wars to encode the spins.
  - Using time-multiplexing as done in referend [2] <br/> ![alt text](ref_schematic1.png | width=100)<br>
  - Using wavelength-multiplexing as done in reference [3] <br/> ![alt text](ref_schematic2.png | width =100)<br>
